...
class sut(object):
    ...
    def act8(self):
        ...
        int1 = 1
        '''
        self.__test.append(('''self.p_int[1] = 1 ''',self.guard8,self.act8))
        if self.__verboseActions:
            __bV = {}
    ...
    def act9(self):
        ...
        int1 = 2
        '''
        self.__test.append(('''self.p_int[1] = 2 ''',self.guard9,self.act9))
        if self.__verboseActions:
            __bV = {}
    ...
    def act10(self):
        ...
        int1 = 3
        '''
        self.__test.append(('''self.p_int[1] = 3 ''',self.guard10,self.act10))
        if self.__verboseActions:
            __bV = {}
    ...
    def act11(self):
        ...
        int1 = 4
        '''
        self.__test.append(('''self.p_int[1] = 4 ''',self.guard11,self.act11))
        if self.__verboseActions:
            __bV = {}
    ...
    def act12(self):
        ...
        int1 = 5
        '''
        self.__test.append(('''self.p_int[1] = 5 ''',self.guard12,self.act12))
        if self.__verboseActions:
            __bV = {}
    ...
    def act13(self):
        ...
        int1 = 6
        '''
        self.__test.append(('''self.p_int[1] = 6 ''',self.guard13,self.act13))
        if self.__verboseActions:
            __bV = {}
    ...
    def act14(self):
        ...
        int1 = 7
        '''
        self.__test.append(('''self.p_int[1] = 7 ''',self.guard14,self.act14))
        if self.__verboseActions:
            __bV = {}
    ...
    def act15(self):
        ...
        int1 = 8
        '''
        self.__test.append(('''self.p_int[1] = 8 ''',self.guard15,self.act15))
        if self.__verboseActions:
            __bV = {}
    ...
    def act16(self):
        ...
        int0 += 1
        '''
        self.__test.append(('''self.p_int[0] += 1 ''',self.guard16,self.act16))
        if self.__verboseActions:
            __bV = {}
            print 'ACTION:',self.prettyName('''self.p_int[0] += 1 ''')
            try: __bV['''self.p_int[0]'''] = repr(self.p_int[0]); print self.prettyName('''self.p_int[0]''') + ' =', __bV['''self.p_int[0]'''], ':',type(self.p_int[0])
    ...
    def act17(self):
        ...
        int1 += 1
        '''
        self.__test.append(('''self.p_int[1] += 1 ''',self.guard17,self.act17))
        if self.__verboseActions:
            __bV = {}
            print 'ACTION:',self.prettyName('''self.p_int[1] += 1 ''')
            try: __bV['''self.p_int[1]'''] = repr(self.p_int[1]); print self.prettyName('''self.p_int[1]''') + ' =', __bV['''self.p_int[1]'''], ':',type(self.p_int[1])
    ...
    # END INITIALIZATION CODE
        ...
        self.__actionClasses.append('''<int> := <[1..8]> ''')
        self.__actionClasses.append('''~<int> += 1 ''')
        self.__dependencies = {}
        self.__dependencies['''<int> := <[1..8]> '''] = []
        self.__dependencies['''~<int> += 1 '''] = []
        self.__dependencies['''~<int> += 1 '''].append(['<int> := <[1..8]> '])
        self.__orderings = {}
        self.__okExcepts = {}
        self.__preCode = {}
        self.__refCode = {}
        ...
        self.__actionClass['''self.p_int[0] = 1 '''] = '''<int> := <[1..8]> '''
        ...
        self.__actionClass['''self.p_int[0] = 2 '''] = '''<int> := <[1..8]> '''
        ...
        self.__actionClass['''self.p_int[0] = 3 '''] = '''<int> := <[1..8]> '''
        ...
        self.__actionClass['''self.p_int[0] = 4 '''] = '''<int> := <[1..8]> '''
        ...
        self.__actionClass['''self.p_int[0] = 5 '''] = '''<int> := <[1..8]> '''
        ...
        self.__actionClass['''self.p_int[0] = 6 '''] = '''<int> := <[1..8]> '''
        ...
        self.__actionClass['''self.p_int[0] = 7 '''] = '''<int> := <[1..8]> '''
        ...
        self.__actionClass['''self.p_int[0] = 8 '''] = '''<int> := <[1..8]> '''

        self.__orderings['''self.p_int[0] = 8 '''] = 8

        self.__okExcepts['''self.p_int[0] = 8 '''] = ''''''

        self.__actions.append(('''self.p_int[1] = 1 ''',self.guard8,self.act8))

        self.__names['''self.p_int[1] = 1 '''] = ('''self.p_int[1] = 1 ''',self.guard8,self.act8)

        self.__actionClass['''self.p_int[1] = 1 '''] = '''<int> := <[1..8]> '''

        self.__orderings['''self.p_int[1] = 1 '''] = 9

        self.__okExcepts['''self.p_int[1] = 1 '''] = ''''''

        self.__actions.append(('''self.p_int[1] = 2 ''',self.guard9,self.act9))

        self.__names['''self.p_int[1] = 2 '''] = ('''self.p_int[1] = 2 ''',self.guard9,self.act9)

        self.__actionClass['''self.p_int[1] = 2 '''] = '''<int> := <[1..8]> '''

        self.__orderings['''self.p_int[1] = 2 '''] = 10

        self.__okExcepts['''self.p_int[1] = 2 '''] = ''''''

        self.__actions.append(('''self.p_int[1] = 3 ''',self.guard10,self.act10))

        self.__names['''self.p_int[1] = 3 '''] = ('''self.p_int[1] = 3 ''',self.guard10,self.act10)

        self.__actionClass['''self.p_int[1] = 3 '''] = '''<int> := <[1..8]> '''

        self.__orderings['''self.p_int[1] = 3 '''] = 11

        self.__okExcepts['''self.p_int[1] = 3 '''] = ''''''

        self.__actions.append(('''self.p_int[1] = 4 ''',self.guard11,self.act11))

        self.__names['''self.p_int[1] = 4 '''] = ('''self.p_int[1] = 4 ''',self.guard11,self.act11)

        self.__actionClass['''self.p_int[1] = 4 '''] = '''<int> := <[1..8]> '''

        self.__orderings['''self.p_int[1] = 4 '''] = 12

        self.__okExcepts['''self.p_int[1] = 4 '''] = ''''''

        self.__actions.append(('''self.p_int[1] = 5 ''',self.guard12,self.act12))

        self.__names['''self.p_int[1] = 5 '''] = ('''self.p_int[1] = 5 ''',self.guard12,self.act12)

        self.__actionClass['''self.p_int[1] = 5 '''] = '''<int> := <[1..8]> '''

        self.__orderings['''self.p_int[1] = 5 '''] = 13

        self.__okExcepts['''self.p_int[1] = 5 '''] = ''''''

        self.__actions.append(('''self.p_int[1] = 6 ''',self.guard13,self.act13))

        self.__names['''self.p_int[1] = 6 '''] = ('''self.p_int[1] = 6 ''',self.guard13,self.act13)

        self.__actionClass['''self.p_int[1] = 6 '''] = '''<int> := <[1..8]> '''

        self.__orderings['''self.p_int[1] = 6 '''] = 14

        self.__okExcepts['''self.p_int[1] = 6 '''] = ''''''

        self.__actions.append(('''self.p_int[1] = 7 ''',self.guard14,self.act14))

        self.__names['''self.p_int[1] = 7 '''] = ('''self.p_int[1] = 7 ''',self.guard14,self.act14)

        self.__actionClass['''self.p_int[1] = 7 '''] = '''<int> := <[1..8]> '''

        self.__orderings['''self.p_int[1] = 7 '''] = 15

        self.__okExcepts['''self.p_int[1] = 7 '''] = ''''''

        self.__actions.append(('''self.p_int[1] = 8 ''',self.guard15,self.act15))

        self.__names['''self.p_int[1] = 8 '''] = ('''self.p_int[1] = 8 ''',self.guard15,self.act15)

        self.__actionClass['''self.p_int[1] = 8 '''] = '''<int> := <[1..8]> '''

        self.__orderings['''self.p_int[1] = 8 '''] = 16

        self.__okExcepts['''self.p_int[1] = 8 '''] = ''''''

        self.__actions.append(('''self.p_int[0] += 1 ''',self.guard16,self.act16))

        self.__names['''self.p_int[0] += 1 '''] = ('''self.p_int[0] += 1 ''',self.guard16,self.act16)

        self.__actionClass['''self.p_int[0] += 1 '''] = '''~<int> += 1 '''

        self.__orderings['''self.p_int[0] += 1 '''] = 17

        self.__okExcepts['''self.p_int[0] += 1 '''] = ''''''

        self.__actions.append(('''self.p_int[1] += 1 ''',self.guard17,self.act17))

        self.__names['''self.p_int[1] += 1 '''] = ('''self.p_int[1] += 1 ''',self.guard17,self.act17)

        self.__actionClass['''self.p_int[1] += 1 '''] = '''~<int> += 1 '''

        self.__orderings['''self.p_int[1] += 1 '''] = 18
    ...
    def check(self):
        try:
            ...
            if (self.p_int[0] != None): # CHECK POOL INIT
                assert (self.p_int[0] != 3)
            # GLOBAL self.p_int[1]
            if (self.p_int[1] != None): # CHECK POOL INIT
                assert (self.p_int[1] != 3)
            # END CHECK CODE
