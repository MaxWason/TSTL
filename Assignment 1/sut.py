...
class sut(object):
    ...
    def act10(self):
        ...
        int1 = 0
        '''
        self.__test.append(('''self.p_int[1] = 0 ''',self.guard10,self.act10))
        if self.__verboseActions:
            __bV = {}
    ...
    def act11(self):
        ...
        int1 = 1
        '''
        self.__test.append(('''self.p_int[1] = 1 ''',self.guard11,self.act11))
        if self.__verboseActions:
            __bV = {}
    ...
    def act12(self):
        ...
        int1 = 2
        '''
        self.__test.append(('''self.p_int[1] = 2 ''',self.guard12,self.act12))
        if self.__verboseActions:
            __bV = {}
    ...
    def act13(self):
        ...
        int1 = 3
        '''
        self.__test.append(('''self.p_int[1] = 3 ''',self.guard13,self.act13))
        if self.__verboseActions:
            __bV = {}
    ...
    def act14(self):
        ...
        int1 = 4
        '''
        self.__test.append(('''self.p_int[1] = 4 ''',self.guard14,self.act14))
        if self.__verboseActions:
            __bV = {}
    ...
    def act15(self):
        ...
        int1 = 5
        '''
        self.__test.append(('''self.p_int[1] = 5 ''',self.guard15,self.act15))
        if self.__verboseActions:
            __bV = {}
    ...
    def act16(self):
        ...
        int1 = 6
        '''
        self.__test.append(('''self.p_int[1] = 6 ''',self.guard16,self.act16))
        if self.__verboseActions:
            __bV = {}
    ...
    def act17(self):
        ...
        int1 = 7
        '''
        self.__test.append(('''self.p_int[1] = 7 ''',self.guard17,self.act17))
        if self.__verboseActions:
            __bV = {}
    ...
    def act18(self):
        ...
        int1 = 8
        '''
        self.__test.append(('''self.p_int[1] = 8 ''',self.guard18,self.act18))
        if self.__verboseActions:
            __bV = {}
    ...
    def act19(self):
        ...
        int1 = 9
        '''
        self.__test.append(('''self.p_int[1] = 9 ''',self.guard19,self.act19))
        if self.__verboseActions:
            __bV = {}
    ...
    def act20(self):
        ...
        int2 = 0
        '''
        self.__test.append(('''self.p_int[2] = 0 ''',self.guard20,self.act20))
        if self.__verboseActions:
            __bV = {}
    ...
    def act21(self):
        ...
        int2 = 1
        '''
        self.__test.append(('''self.p_int[2] = 1 ''',self.guard21,self.act21))
        if self.__verboseActions:
            __bV = {}
    ...
    def act22(self):
        ...
        int2 = 2
        '''
        self.__test.append(('''self.p_int[2] = 2 ''',self.guard22,self.act22))
        if self.__verboseActions:
            __bV = {}
    ...
    def act23(self):
        ...
        int2 = 3
        '''
        self.__test.append(('''self.p_int[2] = 3 ''',self.guard23,self.act23))
        if self.__verboseActions:
            __bV = {}
    ...
    def act24(self):
        ...
        int2 = 4
        '''
        self.__test.append(('''self.p_int[2] = 4 ''',self.guard24,self.act24))
        if self.__verboseActions:
            __bV = {}
    ...
    def act25(self):
        ...
        int2 = 5
        '''
        self.__test.append(('''self.p_int[2] = 5 ''',self.guard25,self.act25))
        if self.__verboseActions:
            __bV = {}
    ...
    def act26(self):
        ...
        int2 = 6
        '''
        self.__test.append(('''self.p_int[2] = 6 ''',self.guard26,self.act26))
        if self.__verboseActions:
            __bV = {}
    ...
    def act27(self):
        ...
        int2 = 7
        '''
        self.__test.append(('''self.p_int[2] = 7 ''',self.guard27,self.act27))
        if self.__verboseActions:
            __bV = {}
    ...
    def act28(self):
        ...
        int2 = 8
        '''
        self.__test.append(('''self.p_int[2] = 8 ''',self.guard28,self.act28))
        if self.__verboseActions:
            __bV = {}
    ...
    def act29(self):
        ...
        int2 = 9
        '''
        self.__test.append(('''self.p_int[2] = 9 ''',self.guard29,self.act29))
        if self.__verboseActions:
            __bV = {}
    ...
    def act30(self):
        ...
        int3 = 0
        '''
        self.__test.append(('''self.p_int[3] = 0 ''',self.guard30,self.act30))
        if self.__verboseActions:
            __bV = {}
    ...
    def act31(self):
        ...
        int3 = 1
        '''
        self.__test.append(('''self.p_int[3] = 1 ''',self.guard31,self.act31))
        if self.__verboseActions:
            __bV = {}
    ...
    def act32(self):
        ...
        int3 = 2
        '''
        self.__test.append(('''self.p_int[3] = 2 ''',self.guard32,self.act32))
        if self.__verboseActions:
            __bV = {}
    ...
    def act33(self):
        ...
        int3 = 3
        '''
        self.__test.append(('''self.p_int[3] = 3 ''',self.guard33,self.act33))
        if self.__verboseActions:
            __bV = {}
    ...
    def act34(self):
        ...
        int3 = 4
        '''
        self.__test.append(('''self.p_int[3] = 4 ''',self.guard34,self.act34))
        if self.__verboseActions:
            __bV = {}
    ...
    def act35(self):
        ...
        int3 = 5
        '''
        self.__test.append(('''self.p_int[3] = 5 ''',self.guard35,self.act35))
        if self.__verboseActions:
            __bV = {}
    ...
    def act36(self):
        ...
        int3 = 6
        '''
        self.__test.append(('''self.p_int[3] = 6 ''',self.guard36,self.act36))
        if self.__verboseActions:
            __bV = {}
    ...
    def act37(self):
        ...
        int3 = 7
        '''
        self.__test.append(('''self.p_int[3] = 7 ''',self.guard37,self.act37))
        if self.__verboseActions:
            __bV = {}
    ...
    def act38(self):
        ...
        int3 = 8
        '''
        self.__test.append(('''self.p_int[3] = 8 ''',self.guard38,self.act38))
        if self.__verboseActions:
            __bV = {}
    ...
    def act39(self):
        ...
        int3 = 9
        '''
        self.__test.append(('''self.p_int[3] = 9 ''',self.guard39,self.act39))
        if self.__verboseActions:
            __bV = {}
    ...
    def act40(self):
        ...
        int0 += 1
        '''
        self.__test.append(('''self.p_int[0] += 1 ''',self.guard40,self.act40))
        if self.__verboseActions:
            __bV = {}
            print 'ACTION:',self.prettyName('''self.p_int[0] += 1 ''')
            try: __bV['''self.p_int[0]'''] = repr(self.p_int[0]); print self.prettyName('''self.p_int[0]''') + ' =', __bV['''self.p_int[0]'''], ':',type(self.p_int[0])
    ...
    def guard40(self):
        return (self.p_int[0] != None)
    
    def act41(self):
        '''
        int1 += 1
        '''
        self.__test.append(('''self.p_int[1] += 1 ''',self.guard41,self.act41))
        if self.__verboseActions:
            __bV = {}
            print 'ACTION:',self.prettyName('''self.p_int[1] += 1 ''')
            try: __bV['''self.p_int[1]'''] = repr(self.p_int[1]); print self.prettyName('''self.p_int[1]''') + ' =', __bV['''self.p_int[1]'''], ':',type(self.p_int[1])
    ...
    def guard41(self):
        return (self.p_int[1] != None)
    
    def act42(self):
        '''
        int2 += 1
        '''
        self.__test.append(('''self.p_int[2] += 1 ''',self.guard42,self.act42))
        if self.__verboseActions:
            __bV = {}
            print 'ACTION:',self.prettyName('''self.p_int[2] += 1 ''')
            try: __bV['''self.p_int[2]'''] = repr(self.p_int[2]); print self.prettyName('''self.p_int[2]''') + ' =', __bV['''self.p_int[2]'''], ':',type(self.p_int[2])
    ...
    def guard42(self):
        return (self.p_int[2] != None)
    
    def act43(self):
        '''
        int3 += 1
        '''
        self.__test.append(('''self.p_int[3] += 1 ''',self.guard43,self.act43))
        if self.__verboseActions:
            __bV = {}
            print 'ACTION:',self.prettyName('''self.p_int[3] += 1 ''')
            try: __bV['''self.p_int[3]'''] = repr(self.p_int[3]); print self.prettyName('''self.p_int[3]''') + ' =', __bV['''self.p_int[3]'''], ':',type(self.p_int[3])
    ...
    def guard43(self):
        return (self.p_int[3] != None)
    
    def act44(self):
        '''
        int0 -= 1
        '''
        self.__test.append(('''self.p_int[0] -= 1 ''',self.guard44,self.act44))
        if self.__verboseActions:
            __bV = {}
            print 'ACTION:',self.prettyName('''self.p_int[0] -= 1 ''')
            try: __bV['''self.p_int[0]'''] = repr(self.p_int[0]); print self.prettyName('''self.p_int[0]''') + ' =', __bV['''self.p_int[0]'''], ':',type(self.p_int[0])
    ...
    def act45(self):
        ...
        int1 -= 1
        '''
        self.__test.append(('''self.p_int[1] -= 1 ''',self.guard45,self.act45))
        if self.__verboseActions:
            __bV = {}
            print 'ACTION:',self.prettyName('''self.p_int[1] -= 1 ''')
            try: __bV['''self.p_int[1]'''] = repr(self.p_int[1]); print self.prettyName('''self.p_int[1]''') + ' =', __bV['''self.p_int[1]'''], ':',type(self.p_int[1])
    ...
    def act46(self):
        ...
        int2 -= 1
        '''
        self.__test.append(('''self.p_int[2] -= 1 ''',self.guard46,self.act46))
        if self.__verboseActions:
            __bV = {}
            print 'ACTION:',self.prettyName('''self.p_int[2] -= 1 ''')
            try: __bV['''self.p_int[2]'''] = repr(self.p_int[2]); print self.prettyName('''self.p_int[2]''') + ' =', __bV['''self.p_int[2]'''], ':',type(self.p_int[2])
    ...
    def act47(self):
        ...
        int3 -= 1
        '''
        self.__test.append(('''self.p_int[3] -= 1 ''',self.guard47,self.act47))
        if self.__verboseActions:
            __bV = {}
            print 'ACTION:',self.prettyName('''self.p_int[3] -= 1 ''')
            try: __bV['''self.p_int[3]'''] = repr(self.p_int[3]); print self.prettyName('''self.p_int[3]''') + ' =', __bV['''self.p_int[3]'''], ':',type(self.p_int[3])
    ...
    def act48(self):
        ...
        int0 *= int0
        '''
        self.__test.append(('''self.p_int[0] *= self.p_int[0] ''',self.guard48,self.act48))
        if self.__verboseActions:
            __bV = {}
            print 'ACTION:',self.prettyName('''self.p_int[0] *= self.p_int[0] ''')
            try: __bV['''self.p_int[0]'''] = repr(self.p_int[0]); print self.prettyName('''self.p_int[0]''') + ' =', __bV['''self.p_int[0]'''], ':',type(self.p_int[0])
            except: pass
        if self.__collectCov: self.__cov.start()
        try: test_before_each(self)
    ...
    def guard48(self):
        ...
        int0 < 5
        '''
        return (self.p_int[0] != None) and (self.p_int[0] < 5)
    
    def act49(self):
        '''
        int0 *= int1
        '''
        self.__test.append(('''self.p_int[0] *= self.p_int[1] ''',self.guard49,self.act49))
        if self.__verboseActions:
            __bV = {}
            print 'ACTION:',self.prettyName('''self.p_int[0] *= self.p_int[1] ''')
            try: __bV['''self.p_int[0]'''] = repr(self.p_int[0]); print self.prettyName('''self.p_int[0]''') + ' =', __bV['''self.p_int[0]'''], ':',type(self.p_int[0])
            except: pass
            try: __bV['''self.p_int[1]'''] = repr(self.p_int[1]); print self.prettyName('''self.p_int[1]''') + ' =', __bV['''self.p_int[1]'''], ':',type(self.p_int[1])
            except: pass
    ...
    def guard49(self):
        ...
        int1 < 5
        '''
        return (self.p_int[0] != None) and (self.p_int[1] != None) and (self.p_int[1] < 5)
    
    def act50(self):
        '''
        int0 *= int2
        '''
        self.__test.append(('''self.p_int[0] *= self.p_int[2] ''',self.guard50,self.act50))
        if self.__verboseActions:
            __bV = {}
            print 'ACTION:',self.prettyName('''self.p_int[0] *= self.p_int[2] ''')
            try: __bV['''self.p_int[0]'''] = repr(self.p_int[0]); print self.prettyName('''self.p_int[0]''') + ' =', __bV['''self.p_int[0]'''], ':',type(self.p_int[0])
            except: pass
            try: __bV['''self.p_int[2]'''] = repr(self.p_int[2]); print self.prettyName('''self.p_int[2]''') + ' =', __bV['''self.p_int[2]'''], ':',type(self.p_int[2])
            except: pass
    ...
    def guard50(self):
        ...
        int2 < 5
        '''
        return (self.p_int[0] != None) and (self.p_int[2] != None) and (self.p_int[2] < 5)
    
    def act51(self):
        '''
        int0 *= int3
        '''
        self.__test.append(('''self.p_int[0] *= self.p_int[3] ''',self.guard51,self.act51))
        if self.__verboseActions:
            __bV = {}
            print 'ACTION:',self.prettyName('''self.p_int[0] *= self.p_int[3] ''')
            try: __bV['''self.p_int[0]'''] = repr(self.p_int[0]); print self.prettyName('''self.p_int[0]''') + ' =', __bV['''self.p_int[0]'''], ':',type(self.p_int[0])
            except: pass
            try: __bV['''self.p_int[3]'''] = repr(self.p_int[3]); print self.prettyName('''self.p_int[3]''') + ' =', __bV['''self.p_int[3]'''], ':',type(self.p_int[3])
            except: pass
    ...
    def guard51(self):
        ...
        int3 < 5
        '''
        return (self.p_int[0] != None) and (self.p_int[3] != None) and (self.p_int[3] < 5)
    
    def act52(self):
        '''
        int1 *= int0
        '''
        self.__test.append(('''self.p_int[1] *= self.p_int[0] ''',self.guard52,self.act52))
        if self.__verboseActions:
            __bV = {}
            print 'ACTION:',self.prettyName('''self.p_int[1] *= self.p_int[0] ''')
            try: __bV['''self.p_int[1]'''] = repr(self.p_int[1]); print self.prettyName('''self.p_int[1]''') + ' =', __bV['''self.p_int[1]'''], ':',type(self.p_int[1])
            except: pass
            try: __bV['''self.p_int[0]'''] = repr(self.p_int[0]); print self.prettyName('''self.p_int[0]''') + ' =', __bV['''self.p_int[0]'''], ':',type(self.p_int[0])
            except: pass
    ...
    def guard52(self):
        ...
        int0 < 5
        '''
        return (self.p_int[1] != None) and (self.p_int[0] != None) and (self.p_int[0] < 5)
    
    def act53(self):
        '''
        int1 *= int1
        '''
        self.__test.append(('''self.p_int[1] *= self.p_int[1] ''',self.guard53,self.act53))
        if self.__verboseActions:
            __bV = {}
            print 'ACTION:',self.prettyName('''self.p_int[1] *= self.p_int[1] ''')
            try: __bV['''self.p_int[1]'''] = repr(self.p_int[1]); print self.prettyName('''self.p_int[1]''') + ' =', __bV['''self.p_int[1]'''], ':',type(self.p_int[1])
            except: pass
        if self.__collectCov: self.__cov.start()
        try: test_before_each(self)
    ...
    def guard53(self):
        ...
        int1 < 5
        '''
        return (self.p_int[1] != None) and (self.p_int[1] < 5)
    
    def act54(self):
        '''
        int1 *= int2
        '''
        self.__test.append(('''self.p_int[1] *= self.p_int[2] ''',self.guard54,self.act54))
        if self.__verboseActions:
            __bV = {}
            print 'ACTION:',self.prettyName('''self.p_int[1] *= self.p_int[2] ''')
            try: __bV['''self.p_int[1]'''] = repr(self.p_int[1]); print self.prettyName('''self.p_int[1]''') + ' =', __bV['''self.p_int[1]'''], ':',type(self.p_int[1])
            except: pass
            try: __bV['''self.p_int[2]'''] = repr(self.p_int[2]); print self.prettyName('''self.p_int[2]''') + ' =', __bV['''self.p_int[2]'''], ':',type(self.p_int[2])
            except: pass
    ...
    def guard54(self):
        ...
        int2 < 5
        '''
        return (self.p_int[1] != None) and (self.p_int[2] != None) and (self.p_int[2] < 5)
    
    def act55(self):
        '''
        int1 *= int3
        '''
        self.__test.append(('''self.p_int[1] *= self.p_int[3] ''',self.guard55,self.act55))
        if self.__verboseActions:
            __bV = {}
            print 'ACTION:',self.prettyName('''self.p_int[1] *= self.p_int[3] ''')
            try: __bV['''self.p_int[1]'''] = repr(self.p_int[1]); print self.prettyName('''self.p_int[1]''') + ' =', __bV['''self.p_int[1]'''], ':',type(self.p_int[1])
            except: pass
            try: __bV['''self.p_int[3]'''] = repr(self.p_int[3]); print self.prettyName('''self.p_int[3]''') + ' =', __bV['''self.p_int[3]'''], ':',type(self.p_int[3])
            except: pass
    ...
    def guard55(self):
        ...
        int3 < 5
        '''
        return (self.p_int[1] != None) and (self.p_int[3] != None) and (self.p_int[3] < 5)
    
    def act56(self):
        '''
        int2 *= int0
        '''
        self.__test.append(('''self.p_int[2] *= self.p_int[0] ''',self.guard56,self.act56))
        if self.__verboseActions:
            __bV = {}
            print 'ACTION:',self.prettyName('''self.p_int[2] *= self.p_int[0] ''')
            try: __bV['''self.p_int[2]'''] = repr(self.p_int[2]); print self.prettyName('''self.p_int[2]''') + ' =', __bV['''self.p_int[2]'''], ':',type(self.p_int[2])
            except: pass
            try: __bV['''self.p_int[0]'''] = repr(self.p_int[0]); print self.prettyName('''self.p_int[0]''') + ' =', __bV['''self.p_int[0]'''], ':',type(self.p_int[0])
            except: pass
    ...
    def guard56(self):
        ...
        int0 < 5
        '''
        return (self.p_int[2] != None) and (self.p_int[0] != None) and (self.p_int[0] < 5)
    
    def act57(self):
        '''
        int2 *= int1
        '''
        self.__test.append(('''self.p_int[2] *= self.p_int[1] ''',self.guard57,self.act57))
        if self.__verboseActions:
            __bV = {}
            print 'ACTION:',self.prettyName('''self.p_int[2] *= self.p_int[1] ''')
            try: __bV['''self.p_int[2]'''] = repr(self.p_int[2]); print self.prettyName('''self.p_int[2]''') + ' =', __bV['''self.p_int[2]'''], ':',type(self.p_int[2])
            except: pass
            try: __bV['''self.p_int[1]'''] = repr(self.p_int[1]); print self.prettyName('''self.p_int[1]''') + ' =', __bV['''self.p_int[1]'''], ':',type(self.p_int[1])
            except: pass
    ...
    def guard57(self):
        ...
        int1 < 5
        '''
        return (self.p_int[2] != None) and (self.p_int[1] != None) and (self.p_int[1] < 5)
    
    def act58(self):
        '''
        int2 *= int2
        '''
        self.__test.append(('''self.p_int[2] *= self.p_int[2] ''',self.guard58,self.act58))
        if self.__verboseActions:
            __bV = {}
            print 'ACTION:',self.prettyName('''self.p_int[2] *= self.p_int[2] ''')
            try: __bV['''self.p_int[2]'''] = repr(self.p_int[2]); print self.prettyName('''self.p_int[2]''') + ' =', __bV['''self.p_int[2]'''], ':',type(self.p_int[2])
            except: pass
        if self.__collectCov: self.__cov.start()
        try: test_before_each(self)
    ...
    def guard58(self):
        ...
        int2 < 5
        '''
        return (self.p_int[2] != None) and (self.p_int[2] < 5)
    
    def act59(self):
        '''
        int2 *= int3
        '''
        self.__test.append(('''self.p_int[2] *= self.p_int[3] ''',self.guard59,self.act59))
        if self.__verboseActions:
            __bV = {}
            print 'ACTION:',self.prettyName('''self.p_int[2] *= self.p_int[3] ''')
            try: __bV['''self.p_int[2]'''] = repr(self.p_int[2]); print self.prettyName('''self.p_int[2]''') + ' =', __bV['''self.p_int[2]'''], ':',type(self.p_int[2])
            except: pass
            try: __bV['''self.p_int[3]'''] = repr(self.p_int[3]); print self.prettyName('''self.p_int[3]''') + ' =', __bV['''self.p_int[3]'''], ':',type(self.p_int[3])
            except: pass
    ...
    def guard59(self):
        ...
        int3 < 5
        '''
        return (self.p_int[2] != None) and (self.p_int[3] != None) and (self.p_int[3] < 5)
    
    def act60(self):
        '''
        int3 *= int0
        '''
        self.__test.append(('''self.p_int[3] *= self.p_int[0] ''',self.guard60,self.act60))
        if self.__verboseActions:
            __bV = {}
            print 'ACTION:',self.prettyName('''self.p_int[3] *= self.p_int[0] ''')
            try: __bV['''self.p_int[3]'''] = repr(self.p_int[3]); print self.prettyName('''self.p_int[3]''') + ' =', __bV['''self.p_int[3]'''], ':',type(self.p_int[3])
            except: pass
            try: __bV['''self.p_int[0]'''] = repr(self.p_int[0]); print self.prettyName('''self.p_int[0]''') + ' =', __bV['''self.p_int[0]'''], ':',type(self.p_int[0])
            except: pass
    ...
    def guard60(self):
        ...
        int0 < 5
        '''
        return (self.p_int[3] != None) and (self.p_int[0] != None) and (self.p_int[0] < 5)
    
    def act61(self):
        '''
        int3 *= int1
        '''
        self.__test.append(('''self.p_int[3] *= self.p_int[1] ''',self.guard61,self.act61))
        if self.__verboseActions:
            __bV = {}
            print 'ACTION:',self.prettyName('''self.p_int[3] *= self.p_int[1] ''')
            try: __bV['''self.p_int[3]'''] = repr(self.p_int[3]); print self.prettyName('''self.p_int[3]''') + ' =', __bV['''self.p_int[3]'''], ':',type(self.p_int[3])
            except: pass
            try: __bV['''self.p_int[1]'''] = repr(self.p_int[1]); print self.prettyName('''self.p_int[1]''') + ' =', __bV['''self.p_int[1]'''], ':',type(self.p_int[1])
            except: pass
    ...
    def guard61(self):
        ...
        int1 < 5
        '''
        return (self.p_int[3] != None) and (self.p_int[1] != None) and (self.p_int[1] < 5)
    
    def act62(self):
        '''
        int3 *= int2
        '''
        self.__test.append(('''self.p_int[3] *= self.p_int[2] ''',self.guard62,self.act62))
        if self.__verboseActions:
            __bV = {}
            print 'ACTION:',self.prettyName('''self.p_int[3] *= self.p_int[2] ''')
            try: __bV['''self.p_int[3]'''] = repr(self.p_int[3]); print self.prettyName('''self.p_int[3]''') + ' =', __bV['''self.p_int[3]'''], ':',type(self.p_int[3])
            except: pass
            try: __bV['''self.p_int[2]'''] = repr(self.p_int[2]); print self.prettyName('''self.p_int[2]''') + ' =', __bV['''self.p_int[2]'''], ':',type(self.p_int[2])
            except: pass
    ...
    def guard62(self):
        ...
        int2 < 5
        '''
        return (self.p_int[3] != None) and (self.p_int[2] != None) and (self.p_int[2] < 5)
    
    def act63(self):
        '''
        int3 *= int3
        '''
        self.__test.append(('''self.p_int[3] *= self.p_int[3] ''',self.guard63,self.act63))
        if self.__verboseActions:
            __bV = {}
            print 'ACTION:',self.prettyName('''self.p_int[3] *= self.p_int[3] ''')
            try: __bV['''self.p_int[3]'''] = repr(self.p_int[3]); print self.prettyName('''self.p_int[3]''') + ' =', __bV['''self.p_int[3]'''], ':',type(self.p_int[3])
            except: pass
        if self.__collectCov: self.__cov.start()
        try: test_before_each(self)
    ...
    def guard63(self):
        ...
        int3 < 5
        '''
        return (self.p_int[3] != None) and (self.p_int[3] < 5)
    
    def act64(self):
        '''
        int0 += int0
        '''
        self.__test.append(('''self.p_int[0] += self.p_int[0] ''',self.guard64,self.act64))
        if self.__verboseActions:
            __bV = {}
            print 'ACTION:',self.prettyName('''self.p_int[0] += self.p_int[0] ''')
            try: __bV['''self.p_int[0]'''] = repr(self.p_int[0]); print self.prettyName('''self.p_int[0]''') + ' =', __bV['''self.p_int[0]'''], ':',type(self.p_int[0])
    ...
    def act65(self):
        ...
        int0 += int1
        '''
        self.__test.append(('''self.p_int[0] += self.p_int[1] ''',self.guard65,self.act65))
        if self.__verboseActions:
            __bV = {}
            print 'ACTION:',self.prettyName('''self.p_int[0] += self.p_int[1] ''')
            try: __bV['''self.p_int[0]'''] = repr(self.p_int[0]); print self.prettyName('''self.p_int[0]''') + ' =', __bV['''self.p_int[0]'''], ':',type(self.p_int[0])
    ...
    def act66(self):
        ...
        int0 += int2
        '''
        self.__test.append(('''self.p_int[0] += self.p_int[2] ''',self.guard66,self.act66))
        if self.__verboseActions:
            __bV = {}
            print 'ACTION:',self.prettyName('''self.p_int[0] += self.p_int[2] ''')
            try: __bV['''self.p_int[0]'''] = repr(self.p_int[0]); print self.prettyName('''self.p_int[0]''') + ' =', __bV['''self.p_int[0]'''], ':',type(self.p_int[0])
    ...
    def act67(self):
        ...
        int0 += int3
        '''
        self.__test.append(('''self.p_int[0] += self.p_int[3] ''',self.guard67,self.act67))
        if self.__verboseActions:
            __bV = {}
            print 'ACTION:',self.prettyName('''self.p_int[0] += self.p_int[3] ''')
            try: __bV['''self.p_int[0]'''] = repr(self.p_int[0]); print self.prettyName('''self.p_int[0]''') + ' =', __bV['''self.p_int[0]'''], ':',type(self.p_int[0])
        ...
        self.p_int_used[3]=True
    def guard67(self):
        return (self.p_int[0] != None) and (self.p_int[3] != None)
    
    def act68(self):
        '''
        int1 += int0
        '''
        self.__test.append(('''self.p_int[1] += self.p_int[0] ''',self.guard68,self.act68))
        if self.__verboseActions:
            __bV = {}
            print 'ACTION:',self.prettyName('''self.p_int[1] += self.p_int[0] ''')
            try: __bV['''self.p_int[1]'''] = repr(self.p_int[1]); print self.prettyName('''self.p_int[1]''') + ' =', __bV['''self.p_int[1]'''], ':',type(self.p_int[1])
    ...
    def act69(self):
        ...
        int1 += int1
        '''
        self.__test.append(('''self.p_int[1] += self.p_int[1] ''',self.guard69,self.act69))
        if self.__verboseActions:
            __bV = {}
            print 'ACTION:',self.prettyName('''self.p_int[1] += self.p_int[1] ''')
            try: __bV['''self.p_int[1]'''] = repr(self.p_int[1]); print self.prettyName('''self.p_int[1]''') + ' =', __bV['''self.p_int[1]'''], ':',type(self.p_int[1])
    ...
    def act70(self):
        ...
        int1 += int2
        '''
        self.__test.append(('''self.p_int[1] += self.p_int[2] ''',self.guard70,self.act70))
        if self.__verboseActions:
            __bV = {}
            print 'ACTION:',self.prettyName('''self.p_int[1] += self.p_int[2] ''')
            try: __bV['''self.p_int[1]'''] = repr(self.p_int[1]); print self.prettyName('''self.p_int[1]''') + ' =', __bV['''self.p_int[1]'''], ':',type(self.p_int[1])
    ...
    def act71(self):
        ...
        int1 += int3
        '''
        self.__test.append(('''self.p_int[1] += self.p_int[3] ''',self.guard71,self.act71))
        if self.__verboseActions:
            __bV = {}
            print 'ACTION:',self.prettyName('''self.p_int[1] += self.p_int[3] ''')
            try: __bV['''self.p_int[1]'''] = repr(self.p_int[1]); print self.prettyName('''self.p_int[1]''') + ' =', __bV['''self.p_int[1]'''], ':',type(self.p_int[1])
        ...
        self.p_int_used[3]=True
    def guard71(self):
        return (self.p_int[1] != None) and (self.p_int[3] != None)
    
    def act72(self):
        '''
        int2 += int0
        '''
        self.__test.append(('''self.p_int[2] += self.p_int[0] ''',self.guard72,self.act72))
        if self.__verboseActions:
            __bV = {}
            print 'ACTION:',self.prettyName('''self.p_int[2] += self.p_int[0] ''')
            try: __bV['''self.p_int[2]'''] = repr(self.p_int[2]); print self.prettyName('''self.p_int[2]''') + ' =', __bV['''self.p_int[2]'''], ':',type(self.p_int[2])
    ...
    def act73(self):
        ...
        int2 += int1
        '''
        self.__test.append(('''self.p_int[2] += self.p_int[1] ''',self.guard73,self.act73))
        if self.__verboseActions:
            __bV = {}
            print 'ACTION:',self.prettyName('''self.p_int[2] += self.p_int[1] ''')
            try: __bV['''self.p_int[2]'''] = repr(self.p_int[2]); print self.prettyName('''self.p_int[2]''') + ' =', __bV['''self.p_int[2]'''], ':',type(self.p_int[2])
    ...
    def act74(self):
        ...
        int2 += int2
        '''
        self.__test.append(('''self.p_int[2] += self.p_int[2] ''',self.guard74,self.act74))
        if self.__verboseActions:
            __bV = {}
            print 'ACTION:',self.prettyName('''self.p_int[2] += self.p_int[2] ''')
            try: __bV['''self.p_int[2]'''] = repr(self.p_int[2]); print self.prettyName('''self.p_int[2]''') + ' =', __bV['''self.p_int[2]'''], ':',type(self.p_int[2])
    ...
    def act75(self):
        ...
        int2 += int3
        '''
        self.__test.append(('''self.p_int[2] += self.p_int[3] ''',self.guard75,self.act75))
        if self.__verboseActions:
            __bV = {}
            print 'ACTION:',self.prettyName('''self.p_int[2] += self.p_int[3] ''')
            try: __bV['''self.p_int[2]'''] = repr(self.p_int[2]); print self.prettyName('''self.p_int[2]''') + ' =', __bV['''self.p_int[2]'''], ':',type(self.p_int[2])
        ...
        self.p_int_used[3]=True
    def guard75(self):
        return (self.p_int[2] != None) and (self.p_int[3] != None)
    
    def act76(self):
        '''
        int3 += int0
        '''
        self.__test.append(('''self.p_int[3] += self.p_int[0] ''',self.guard76,self.act76))
        if self.__verboseActions:
            __bV = {}
            print 'ACTION:',self.prettyName('''self.p_int[3] += self.p_int[0] ''')
            try: __bV['''self.p_int[3]'''] = repr(self.p_int[3]); print self.prettyName('''self.p_int[3]''') + ' =', __bV['''self.p_int[3]'''], ':',type(self.p_int[3])
        ...
        self.p_int_used[0]=True
    def guard76(self):
        return (self.p_int[3] != None) and (self.p_int[0] != None)
    
    def act77(self):
        '''
        int3 += int1
        '''
        self.__test.append(('''self.p_int[3] += self.p_int[1] ''',self.guard77,self.act77))
        if self.__verboseActions:
            __bV = {}
            print 'ACTION:',self.prettyName('''self.p_int[3] += self.p_int[1] ''')
            try: __bV['''self.p_int[3]'''] = repr(self.p_int[3]); print self.prettyName('''self.p_int[3]''') + ' =', __bV['''self.p_int[3]'''], ':',type(self.p_int[3])
        ...
        self.p_int_used[1]=True
    def guard77(self):
        return (self.p_int[3] != None) and (self.p_int[1] != None)
    
    def act78(self):
        '''
        int3 += int2
        '''
        self.__test.append(('''self.p_int[3] += self.p_int[2] ''',self.guard78,self.act78))
        if self.__verboseActions:
            __bV = {}
            print 'ACTION:',self.prettyName('''self.p_int[3] += self.p_int[2] ''')
            try: __bV['''self.p_int[3]'''] = repr(self.p_int[3]); print self.prettyName('''self.p_int[3]''') + ' =', __bV['''self.p_int[3]'''], ':',type(self.p_int[3])
        ...
        self.p_int_used[2]=True
    def guard78(self):
        return (self.p_int[3] != None) and (self.p_int[2] != None)
    
    def act79(self):
        '''
        int3 += int3
        '''
        self.__test.append(('''self.p_int[3] += self.p_int[3] ''',self.guard79,self.act79))
        if self.__verboseActions:
            __bV = {}
            print 'ACTION:',self.prettyName('''self.p_int[3] += self.p_int[3] ''')
            try: __bV['''self.p_int[3]'''] = repr(self.p_int[3]); print self.prettyName('''self.p_int[3]''') + ' =', __bV['''self.p_int[3]'''], ':',type(self.p_int[3])
    ...
    def __init__(self):
        try:
            ...
            pass
        self.__modules = []
        self.__modules.append(r"add")
        self.__features = []
        self.__replayBacktrack = False
        self.__cov = coverage.coverage(branch=True, source=["add"]    ,omit='sut.py'    )
    ...
    # END INITIALIZATION CODE
        ...
        self.__actionClasses.append('''<int> := <[0..9]> ''')
        self.__actionClasses.append('''<int> += 1 ''')
        self.__actionClasses.append('''<int> -= 1 ''')
        self.__actionClasses.append('''<int,2> < 5 -> <int> *= <int> ''')
        self.__actionClasses.append('''<int> += <int> ''')
        self.__dependencies = {}
        self.__dependencies['''<int> := <[0..9]> '''] = []
        self.__dependencies['''<int> += 1 '''] = []
        self.__dependencies['''<int> += 1 '''].append(['<int> := <[0..9]> '])
        self.__dependencies['''<int> -= 1 '''] = []
        self.__dependencies['''<int> -= 1 '''].append(['<int> := <[0..9]> '])
        self.__dependencies['''<int,2> < 5 -> <int> *= <int> '''] = []
        self.__dependencies['''<int,2> < 5 -> <int> *= <int> '''].append(['<int> := <[0..9]> '])
        self.__dependencies['''<int> += <int> '''] = []
        self.__dependencies['''<int> += <int> '''].append(['<int> := <[0..9]> '])
        self.__orderings = {}
        self.__okExcepts = {}
        self.__preCode = {}
        self.__refCode = {}
        ...
        self.__actionClass['''self.p_int[0] = 0 '''] = '''<int> := <[0..9]> '''
        ...
        self.__actionClass['''self.p_int[0] = 1 '''] = '''<int> := <[0..9]> '''
        ...
        self.__actionClass['''self.p_int[0] = 2 '''] = '''<int> := <[0..9]> '''
        ...
        self.__actionClass['''self.p_int[0] = 3 '''] = '''<int> := <[0..9]> '''
        ...
        self.__actionClass['''self.p_int[0] = 4 '''] = '''<int> := <[0..9]> '''
        ...
        self.__actionClass['''self.p_int[0] = 5 '''] = '''<int> := <[0..9]> '''
        ...
        self.__actionClass['''self.p_int[0] = 6 '''] = '''<int> := <[0..9]> '''
        ...
        self.__actionClass['''self.p_int[0] = 7 '''] = '''<int> := <[0..9]> '''
        ...
        self.__actionClass['''self.p_int[0] = 8 '''] = '''<int> := <[0..9]> '''
        ...
        self.__actionClass['''self.p_int[0] = 9 '''] = '''<int> := <[0..9]> '''

        self.__orderings['''self.p_int[0] = 9 '''] = 10

        self.__okExcepts['''self.p_int[0] = 9 '''] = ''''''

        self.__actions.append(('''self.p_int[1] = 0 ''',self.guard10,self.act10))

        self.__names['''self.p_int[1] = 0 '''] = ('''self.p_int[1] = 0 ''',self.guard10,self.act10)

        self.__actionClass['''self.p_int[1] = 0 '''] = '''<int> := <[0..9]> '''

        self.__orderings['''self.p_int[1] = 0 '''] = 11

        self.__okExcepts['''self.p_int[1] = 0 '''] = ''''''

        self.__actions.append(('''self.p_int[1] = 1 ''',self.guard11,self.act11))

        self.__names['''self.p_int[1] = 1 '''] = ('''self.p_int[1] = 1 ''',self.guard11,self.act11)

        self.__actionClass['''self.p_int[1] = 1 '''] = '''<int> := <[0..9]> '''

        self.__orderings['''self.p_int[1] = 1 '''] = 12

        self.__okExcepts['''self.p_int[1] = 1 '''] = ''''''

        self.__actions.append(('''self.p_int[1] = 2 ''',self.guard12,self.act12))

        self.__names['''self.p_int[1] = 2 '''] = ('''self.p_int[1] = 2 ''',self.guard12,self.act12)

        self.__actionClass['''self.p_int[1] = 2 '''] = '''<int> := <[0..9]> '''

        self.__orderings['''self.p_int[1] = 2 '''] = 13

        self.__okExcepts['''self.p_int[1] = 2 '''] = ''''''

        self.__actions.append(('''self.p_int[1] = 3 ''',self.guard13,self.act13))

        self.__names['''self.p_int[1] = 3 '''] = ('''self.p_int[1] = 3 ''',self.guard13,self.act13)

        self.__actionClass['''self.p_int[1] = 3 '''] = '''<int> := <[0..9]> '''

        self.__orderings['''self.p_int[1] = 3 '''] = 14

        self.__okExcepts['''self.p_int[1] = 3 '''] = ''''''

        self.__actions.append(('''self.p_int[1] = 4 ''',self.guard14,self.act14))

        self.__names['''self.p_int[1] = 4 '''] = ('''self.p_int[1] = 4 ''',self.guard14,self.act14)

        self.__actionClass['''self.p_int[1] = 4 '''] = '''<int> := <[0..9]> '''

        self.__orderings['''self.p_int[1] = 4 '''] = 15

        self.__okExcepts['''self.p_int[1] = 4 '''] = ''''''

        self.__actions.append(('''self.p_int[1] = 5 ''',self.guard15,self.act15))

        self.__names['''self.p_int[1] = 5 '''] = ('''self.p_int[1] = 5 ''',self.guard15,self.act15)

        self.__actionClass['''self.p_int[1] = 5 '''] = '''<int> := <[0..9]> '''

        self.__orderings['''self.p_int[1] = 5 '''] = 16

        self.__okExcepts['''self.p_int[1] = 5 '''] = ''''''

        self.__actions.append(('''self.p_int[1] = 6 ''',self.guard16,self.act16))

        self.__names['''self.p_int[1] = 6 '''] = ('''self.p_int[1] = 6 ''',self.guard16,self.act16)

        self.__actionClass['''self.p_int[1] = 6 '''] = '''<int> := <[0..9]> '''

        self.__orderings['''self.p_int[1] = 6 '''] = 17

        self.__okExcepts['''self.p_int[1] = 6 '''] = ''''''

        self.__actions.append(('''self.p_int[1] = 7 ''',self.guard17,self.act17))

        self.__names['''self.p_int[1] = 7 '''] = ('''self.p_int[1] = 7 ''',self.guard17,self.act17)

        self.__actionClass['''self.p_int[1] = 7 '''] = '''<int> := <[0..9]> '''

        self.__orderings['''self.p_int[1] = 7 '''] = 18

        self.__okExcepts['''self.p_int[1] = 7 '''] = ''''''

        self.__actions.append(('''self.p_int[1] = 8 ''',self.guard18,self.act18))

        self.__names['''self.p_int[1] = 8 '''] = ('''self.p_int[1] = 8 ''',self.guard18,self.act18)

        self.__actionClass['''self.p_int[1] = 8 '''] = '''<int> := <[0..9]> '''

        self.__orderings['''self.p_int[1] = 8 '''] = 19

        self.__okExcepts['''self.p_int[1] = 8 '''] = ''''''

        self.__actions.append(('''self.p_int[1] = 9 ''',self.guard19,self.act19))

        self.__names['''self.p_int[1] = 9 '''] = ('''self.p_int[1] = 9 ''',self.guard19,self.act19)

        self.__actionClass['''self.p_int[1] = 9 '''] = '''<int> := <[0..9]> '''

        self.__orderings['''self.p_int[1] = 9 '''] = 20

        self.__okExcepts['''self.p_int[1] = 9 '''] = ''''''

        self.__actions.append(('''self.p_int[2] = 0 ''',self.guard20,self.act20))

        self.__names['''self.p_int[2] = 0 '''] = ('''self.p_int[2] = 0 ''',self.guard20,self.act20)

        self.__actionClass['''self.p_int[2] = 0 '''] = '''<int> := <[0..9]> '''

        self.__orderings['''self.p_int[2] = 0 '''] = 21

        self.__okExcepts['''self.p_int[2] = 0 '''] = ''''''

        self.__actions.append(('''self.p_int[2] = 1 ''',self.guard21,self.act21))

        self.__names['''self.p_int[2] = 1 '''] = ('''self.p_int[2] = 1 ''',self.guard21,self.act21)

        self.__actionClass['''self.p_int[2] = 1 '''] = '''<int> := <[0..9]> '''

        self.__orderings['''self.p_int[2] = 1 '''] = 22

        self.__okExcepts['''self.p_int[2] = 1 '''] = ''''''

        self.__actions.append(('''self.p_int[2] = 2 ''',self.guard22,self.act22))

        self.__names['''self.p_int[2] = 2 '''] = ('''self.p_int[2] = 2 ''',self.guard22,self.act22)

        self.__actionClass['''self.p_int[2] = 2 '''] = '''<int> := <[0..9]> '''

        self.__orderings['''self.p_int[2] = 2 '''] = 23

        self.__okExcepts['''self.p_int[2] = 2 '''] = ''''''

        self.__actions.append(('''self.p_int[2] = 3 ''',self.guard23,self.act23))

        self.__names['''self.p_int[2] = 3 '''] = ('''self.p_int[2] = 3 ''',self.guard23,self.act23)

        self.__actionClass['''self.p_int[2] = 3 '''] = '''<int> := <[0..9]> '''

        self.__orderings['''self.p_int[2] = 3 '''] = 24

        self.__okExcepts['''self.p_int[2] = 3 '''] = ''''''

        self.__actions.append(('''self.p_int[2] = 4 ''',self.guard24,self.act24))

        self.__names['''self.p_int[2] = 4 '''] = ('''self.p_int[2] = 4 ''',self.guard24,self.act24)

        self.__actionClass['''self.p_int[2] = 4 '''] = '''<int> := <[0..9]> '''

        self.__orderings['''self.p_int[2] = 4 '''] = 25

        self.__okExcepts['''self.p_int[2] = 4 '''] = ''''''

        self.__actions.append(('''self.p_int[2] = 5 ''',self.guard25,self.act25))

        self.__names['''self.p_int[2] = 5 '''] = ('''self.p_int[2] = 5 ''',self.guard25,self.act25)

        self.__actionClass['''self.p_int[2] = 5 '''] = '''<int> := <[0..9]> '''

        self.__orderings['''self.p_int[2] = 5 '''] = 26

        self.__okExcepts['''self.p_int[2] = 5 '''] = ''''''

        self.__actions.append(('''self.p_int[2] = 6 ''',self.guard26,self.act26))

        self.__names['''self.p_int[2] = 6 '''] = ('''self.p_int[2] = 6 ''',self.guard26,self.act26)

        self.__actionClass['''self.p_int[2] = 6 '''] = '''<int> := <[0..9]> '''

        self.__orderings['''self.p_int[2] = 6 '''] = 27

        self.__okExcepts['''self.p_int[2] = 6 '''] = ''''''

        self.__actions.append(('''self.p_int[2] = 7 ''',self.guard27,self.act27))

        self.__names['''self.p_int[2] = 7 '''] = ('''self.p_int[2] = 7 ''',self.guard27,self.act27)

        self.__actionClass['''self.p_int[2] = 7 '''] = '''<int> := <[0..9]> '''

        self.__orderings['''self.p_int[2] = 7 '''] = 28

        self.__okExcepts['''self.p_int[2] = 7 '''] = ''''''

        self.__actions.append(('''self.p_int[2] = 8 ''',self.guard28,self.act28))

        self.__names['''self.p_int[2] = 8 '''] = ('''self.p_int[2] = 8 ''',self.guard28,self.act28)

        self.__actionClass['''self.p_int[2] = 8 '''] = '''<int> := <[0..9]> '''

        self.__orderings['''self.p_int[2] = 8 '''] = 29

        self.__okExcepts['''self.p_int[2] = 8 '''] = ''''''

        self.__actions.append(('''self.p_int[2] = 9 ''',self.guard29,self.act29))

        self.__names['''self.p_int[2] = 9 '''] = ('''self.p_int[2] = 9 ''',self.guard29,self.act29)

        self.__actionClass['''self.p_int[2] = 9 '''] = '''<int> := <[0..9]> '''

        self.__orderings['''self.p_int[2] = 9 '''] = 30

        self.__okExcepts['''self.p_int[2] = 9 '''] = ''''''

        self.__actions.append(('''self.p_int[3] = 0 ''',self.guard30,self.act30))

        self.__names['''self.p_int[3] = 0 '''] = ('''self.p_int[3] = 0 ''',self.guard30,self.act30)

        self.__actionClass['''self.p_int[3] = 0 '''] = '''<int> := <[0..9]> '''

        self.__orderings['''self.p_int[3] = 0 '''] = 31

        self.__okExcepts['''self.p_int[3] = 0 '''] = ''''''

        self.__actions.append(('''self.p_int[3] = 1 ''',self.guard31,self.act31))

        self.__names['''self.p_int[3] = 1 '''] = ('''self.p_int[3] = 1 ''',self.guard31,self.act31)

        self.__actionClass['''self.p_int[3] = 1 '''] = '''<int> := <[0..9]> '''

        self.__orderings['''self.p_int[3] = 1 '''] = 32

        self.__okExcepts['''self.p_int[3] = 1 '''] = ''''''

        self.__actions.append(('''self.p_int[3] = 2 ''',self.guard32,self.act32))

        self.__names['''self.p_int[3] = 2 '''] = ('''self.p_int[3] = 2 ''',self.guard32,self.act32)

        self.__actionClass['''self.p_int[3] = 2 '''] = '''<int> := <[0..9]> '''

        self.__orderings['''self.p_int[3] = 2 '''] = 33

        self.__okExcepts['''self.p_int[3] = 2 '''] = ''''''

        self.__actions.append(('''self.p_int[3] = 3 ''',self.guard33,self.act33))

        self.__names['''self.p_int[3] = 3 '''] = ('''self.p_int[3] = 3 ''',self.guard33,self.act33)

        self.__actionClass['''self.p_int[3] = 3 '''] = '''<int> := <[0..9]> '''

        self.__orderings['''self.p_int[3] = 3 '''] = 34

        self.__okExcepts['''self.p_int[3] = 3 '''] = ''''''

        self.__actions.append(('''self.p_int[3] = 4 ''',self.guard34,self.act34))

        self.__names['''self.p_int[3] = 4 '''] = ('''self.p_int[3] = 4 ''',self.guard34,self.act34)

        self.__actionClass['''self.p_int[3] = 4 '''] = '''<int> := <[0..9]> '''

        self.__orderings['''self.p_int[3] = 4 '''] = 35

        self.__okExcepts['''self.p_int[3] = 4 '''] = ''''''

        self.__actions.append(('''self.p_int[3] = 5 ''',self.guard35,self.act35))

        self.__names['''self.p_int[3] = 5 '''] = ('''self.p_int[3] = 5 ''',self.guard35,self.act35)

        self.__actionClass['''self.p_int[3] = 5 '''] = '''<int> := <[0..9]> '''

        self.__orderings['''self.p_int[3] = 5 '''] = 36

        self.__okExcepts['''self.p_int[3] = 5 '''] = ''''''

        self.__actions.append(('''self.p_int[3] = 6 ''',self.guard36,self.act36))

        self.__names['''self.p_int[3] = 6 '''] = ('''self.p_int[3] = 6 ''',self.guard36,self.act36)

        self.__actionClass['''self.p_int[3] = 6 '''] = '''<int> := <[0..9]> '''

        self.__orderings['''self.p_int[3] = 6 '''] = 37

        self.__okExcepts['''self.p_int[3] = 6 '''] = ''''''

        self.__actions.append(('''self.p_int[3] = 7 ''',self.guard37,self.act37))

        self.__names['''self.p_int[3] = 7 '''] = ('''self.p_int[3] = 7 ''',self.guard37,self.act37)

        self.__actionClass['''self.p_int[3] = 7 '''] = '''<int> := <[0..9]> '''

        self.__orderings['''self.p_int[3] = 7 '''] = 38

        self.__okExcepts['''self.p_int[3] = 7 '''] = ''''''

        self.__actions.append(('''self.p_int[3] = 8 ''',self.guard38,self.act38))

        self.__names['''self.p_int[3] = 8 '''] = ('''self.p_int[3] = 8 ''',self.guard38,self.act38)

        self.__actionClass['''self.p_int[3] = 8 '''] = '''<int> := <[0..9]> '''

        self.__orderings['''self.p_int[3] = 8 '''] = 39

        self.__okExcepts['''self.p_int[3] = 8 '''] = ''''''

        self.__actions.append(('''self.p_int[3] = 9 ''',self.guard39,self.act39))

        self.__names['''self.p_int[3] = 9 '''] = ('''self.p_int[3] = 9 ''',self.guard39,self.act39)

        self.__actionClass['''self.p_int[3] = 9 '''] = '''<int> := <[0..9]> '''

        self.__orderings['''self.p_int[3] = 9 '''] = 40

        self.__okExcepts['''self.p_int[3] = 9 '''] = ''''''

        self.__actions.append(('''self.p_int[0] += 1 ''',self.guard40,self.act40))

        self.__names['''self.p_int[0] += 1 '''] = ('''self.p_int[0] += 1 ''',self.guard40,self.act40)

        self.__actionClass['''self.p_int[0] += 1 '''] = '''<int> += 1 '''

        self.__orderings['''self.p_int[0] += 1 '''] = 41

        self.__okExcepts['''self.p_int[0] += 1 '''] = ''''''

        self.__actions.append(('''self.p_int[1] += 1 ''',self.guard41,self.act41))

        self.__names['''self.p_int[1] += 1 '''] = ('''self.p_int[1] += 1 ''',self.guard41,self.act41)

        self.__actionClass['''self.p_int[1] += 1 '''] = '''<int> += 1 '''

        self.__orderings['''self.p_int[1] += 1 '''] = 42

        self.__okExcepts['''self.p_int[1] += 1 '''] = ''''''

        self.__actions.append(('''self.p_int[2] += 1 ''',self.guard42,self.act42))

        self.__names['''self.p_int[2] += 1 '''] = ('''self.p_int[2] += 1 ''',self.guard42,self.act42)

        self.__actionClass['''self.p_int[2] += 1 '''] = '''<int> += 1 '''

        self.__orderings['''self.p_int[2] += 1 '''] = 43

        self.__okExcepts['''self.p_int[2] += 1 '''] = ''''''

        self.__actions.append(('''self.p_int[3] += 1 ''',self.guard43,self.act43))

        self.__names['''self.p_int[3] += 1 '''] = ('''self.p_int[3] += 1 ''',self.guard43,self.act43)

        self.__actionClass['''self.p_int[3] += 1 '''] = '''<int> += 1 '''

        self.__orderings['''self.p_int[3] += 1 '''] = 44

        self.__okExcepts['''self.p_int[3] += 1 '''] = ''''''

        self.__actions.append(('''self.p_int[0] -= 1 ''',self.guard44,self.act44))

        self.__names['''self.p_int[0] -= 1 '''] = ('''self.p_int[0] -= 1 ''',self.guard44,self.act44)

        self.__actionClass['''self.p_int[0] -= 1 '''] = '''<int> -= 1 '''

        self.__orderings['''self.p_int[0] -= 1 '''] = 45

        self.__okExcepts['''self.p_int[0] -= 1 '''] = ''''''

        self.__actions.append(('''self.p_int[1] -= 1 ''',self.guard45,self.act45))

        self.__names['''self.p_int[1] -= 1 '''] = ('''self.p_int[1] -= 1 ''',self.guard45,self.act45)

        self.__actionClass['''self.p_int[1] -= 1 '''] = '''<int> -= 1 '''

        self.__orderings['''self.p_int[1] -= 1 '''] = 46

        self.__okExcepts['''self.p_int[1] -= 1 '''] = ''''''

        self.__actions.append(('''self.p_int[2] -= 1 ''',self.guard46,self.act46))

        self.__names['''self.p_int[2] -= 1 '''] = ('''self.p_int[2] -= 1 ''',self.guard46,self.act46)

        self.__actionClass['''self.p_int[2] -= 1 '''] = '''<int> -= 1 '''

        self.__orderings['''self.p_int[2] -= 1 '''] = 47

        self.__okExcepts['''self.p_int[2] -= 1 '''] = ''''''

        self.__actions.append(('''self.p_int[3] -= 1 ''',self.guard47,self.act47))

        self.__names['''self.p_int[3] -= 1 '''] = ('''self.p_int[3] -= 1 ''',self.guard47,self.act47)

        self.__actionClass['''self.p_int[3] -= 1 '''] = '''<int> -= 1 '''

        self.__orderings['''self.p_int[3] -= 1 '''] = 48

        self.__okExcepts['''self.p_int[3] -= 1 '''] = ''''''

        self.__actions.append(('''self.p_int[0] *= self.p_int[0] ''',self.guard48,self.act48))

        self.__names['''self.p_int[0] *= self.p_int[0] '''] = ('''self.p_int[0] *= self.p_int[0] ''',self.guard48,self.act48)

        self.__actionClass['''self.p_int[0] *= self.p_int[0] '''] = '''<int,2> < 5 -> <int> *= <int> '''

        self.__orderings['''self.p_int[0] *= self.p_int[0] '''] = 49

        self.__okExcepts['''self.p_int[0] *= self.p_int[0] '''] = ''''''

        self.__actions.append(('''self.p_int[0] *= self.p_int[1] ''',self.guard49,self.act49))

        self.__names['''self.p_int[0] *= self.p_int[1] '''] = ('''self.p_int[0] *= self.p_int[1] ''',self.guard49,self.act49)

        self.__actionClass['''self.p_int[0] *= self.p_int[1] '''] = '''<int,2> < 5 -> <int> *= <int> '''

        self.__orderings['''self.p_int[0] *= self.p_int[1] '''] = 50

        self.__okExcepts['''self.p_int[0] *= self.p_int[1] '''] = ''''''

        self.__actions.append(('''self.p_int[0] *= self.p_int[2] ''',self.guard50,self.act50))

        self.__names['''self.p_int[0] *= self.p_int[2] '''] = ('''self.p_int[0] *= self.p_int[2] ''',self.guard50,self.act50)

        self.__actionClass['''self.p_int[0] *= self.p_int[2] '''] = '''<int,2> < 5 -> <int> *= <int> '''

        self.__orderings['''self.p_int[0] *= self.p_int[2] '''] = 51

        self.__okExcepts['''self.p_int[0] *= self.p_int[2] '''] = ''''''

        self.__actions.append(('''self.p_int[0] *= self.p_int[3] ''',self.guard51,self.act51))

        self.__names['''self.p_int[0] *= self.p_int[3] '''] = ('''self.p_int[0] *= self.p_int[3] ''',self.guard51,self.act51)

        self.__actionClass['''self.p_int[0] *= self.p_int[3] '''] = '''<int,2> < 5 -> <int> *= <int> '''

        self.__orderings['''self.p_int[0] *= self.p_int[3] '''] = 52

        self.__okExcepts['''self.p_int[0] *= self.p_int[3] '''] = ''''''

        self.__actions.append(('''self.p_int[1] *= self.p_int[0] ''',self.guard52,self.act52))

        self.__names['''self.p_int[1] *= self.p_int[0] '''] = ('''self.p_int[1] *= self.p_int[0] ''',self.guard52,self.act52)

        self.__actionClass['''self.p_int[1] *= self.p_int[0] '''] = '''<int,2> < 5 -> <int> *= <int> '''

        self.__orderings['''self.p_int[1] *= self.p_int[0] '''] = 53

        self.__okExcepts['''self.p_int[1] *= self.p_int[0] '''] = ''''''

        self.__actions.append(('''self.p_int[1] *= self.p_int[1] ''',self.guard53,self.act53))

        self.__names['''self.p_int[1] *= self.p_int[1] '''] = ('''self.p_int[1] *= self.p_int[1] ''',self.guard53,self.act53)

        self.__actionClass['''self.p_int[1] *= self.p_int[1] '''] = '''<int,2> < 5 -> <int> *= <int> '''

        self.__orderings['''self.p_int[1] *= self.p_int[1] '''] = 54

        self.__okExcepts['''self.p_int[1] *= self.p_int[1] '''] = ''''''

        self.__actions.append(('''self.p_int[1] *= self.p_int[2] ''',self.guard54,self.act54))

        self.__names['''self.p_int[1] *= self.p_int[2] '''] = ('''self.p_int[1] *= self.p_int[2] ''',self.guard54,self.act54)

        self.__actionClass['''self.p_int[1] *= self.p_int[2] '''] = '''<int,2> < 5 -> <int> *= <int> '''

        self.__orderings['''self.p_int[1] *= self.p_int[2] '''] = 55

        self.__okExcepts['''self.p_int[1] *= self.p_int[2] '''] = ''''''

        self.__actions.append(('''self.p_int[1] *= self.p_int[3] ''',self.guard55,self.act55))

        self.__names['''self.p_int[1] *= self.p_int[3] '''] = ('''self.p_int[1] *= self.p_int[3] ''',self.guard55,self.act55)

        self.__actionClass['''self.p_int[1] *= self.p_int[3] '''] = '''<int,2> < 5 -> <int> *= <int> '''

        self.__orderings['''self.p_int[1] *= self.p_int[3] '''] = 56

        self.__okExcepts['''self.p_int[1] *= self.p_int[3] '''] = ''''''

        self.__actions.append(('''self.p_int[2] *= self.p_int[0] ''',self.guard56,self.act56))

        self.__names['''self.p_int[2] *= self.p_int[0] '''] = ('''self.p_int[2] *= self.p_int[0] ''',self.guard56,self.act56)

        self.__actionClass['''self.p_int[2] *= self.p_int[0] '''] = '''<int,2> < 5 -> <int> *= <int> '''

        self.__orderings['''self.p_int[2] *= self.p_int[0] '''] = 57

        self.__okExcepts['''self.p_int[2] *= self.p_int[0] '''] = ''''''

        self.__actions.append(('''self.p_int[2] *= self.p_int[1] ''',self.guard57,self.act57))

        self.__names['''self.p_int[2] *= self.p_int[1] '''] = ('''self.p_int[2] *= self.p_int[1] ''',self.guard57,self.act57)

        self.__actionClass['''self.p_int[2] *= self.p_int[1] '''] = '''<int,2> < 5 -> <int> *= <int> '''

        self.__orderings['''self.p_int[2] *= self.p_int[1] '''] = 58

        self.__okExcepts['''self.p_int[2] *= self.p_int[1] '''] = ''''''

        self.__actions.append(('''self.p_int[2] *= self.p_int[2] ''',self.guard58,self.act58))

        self.__names['''self.p_int[2] *= self.p_int[2] '''] = ('''self.p_int[2] *= self.p_int[2] ''',self.guard58,self.act58)

        self.__actionClass['''self.p_int[2] *= self.p_int[2] '''] = '''<int,2> < 5 -> <int> *= <int> '''

        self.__orderings['''self.p_int[2] *= self.p_int[2] '''] = 59

        self.__okExcepts['''self.p_int[2] *= self.p_int[2] '''] = ''''''

        self.__actions.append(('''self.p_int[2] *= self.p_int[3] ''',self.guard59,self.act59))

        self.__names['''self.p_int[2] *= self.p_int[3] '''] = ('''self.p_int[2] *= self.p_int[3] ''',self.guard59,self.act59)

        self.__actionClass['''self.p_int[2] *= self.p_int[3] '''] = '''<int,2> < 5 -> <int> *= <int> '''

        self.__orderings['''self.p_int[2] *= self.p_int[3] '''] = 60

        self.__okExcepts['''self.p_int[2] *= self.p_int[3] '''] = ''''''

        self.__actions.append(('''self.p_int[3] *= self.p_int[0] ''',self.guard60,self.act60))

        self.__names['''self.p_int[3] *= self.p_int[0] '''] = ('''self.p_int[3] *= self.p_int[0] ''',self.guard60,self.act60)

        self.__actionClass['''self.p_int[3] *= self.p_int[0] '''] = '''<int,2> < 5 -> <int> *= <int> '''

        self.__orderings['''self.p_int[3] *= self.p_int[0] '''] = 61

        self.__okExcepts['''self.p_int[3] *= self.p_int[0] '''] = ''''''

        self.__actions.append(('''self.p_int[3] *= self.p_int[1] ''',self.guard61,self.act61))

        self.__names['''self.p_int[3] *= self.p_int[1] '''] = ('''self.p_int[3] *= self.p_int[1] ''',self.guard61,self.act61)

        self.__actionClass['''self.p_int[3] *= self.p_int[1] '''] = '''<int,2> < 5 -> <int> *= <int> '''

        self.__orderings['''self.p_int[3] *= self.p_int[1] '''] = 62

        self.__okExcepts['''self.p_int[3] *= self.p_int[1] '''] = ''''''

        self.__actions.append(('''self.p_int[3] *= self.p_int[2] ''',self.guard62,self.act62))

        self.__names['''self.p_int[3] *= self.p_int[2] '''] = ('''self.p_int[3] *= self.p_int[2] ''',self.guard62,self.act62)

        self.__actionClass['''self.p_int[3] *= self.p_int[2] '''] = '''<int,2> < 5 -> <int> *= <int> '''

        self.__orderings['''self.p_int[3] *= self.p_int[2] '''] = 63

        self.__okExcepts['''self.p_int[3] *= self.p_int[2] '''] = ''''''

        self.__actions.append(('''self.p_int[3] *= self.p_int[3] ''',self.guard63,self.act63))

        self.__names['''self.p_int[3] *= self.p_int[3] '''] = ('''self.p_int[3] *= self.p_int[3] ''',self.guard63,self.act63)

        self.__actionClass['''self.p_int[3] *= self.p_int[3] '''] = '''<int,2> < 5 -> <int> *= <int> '''

        self.__orderings['''self.p_int[3] *= self.p_int[3] '''] = 64

        self.__okExcepts['''self.p_int[3] *= self.p_int[3] '''] = ''''''

        self.__actions.append(('''self.p_int[0] += self.p_int[0] ''',self.guard64,self.act64))

        self.__names['''self.p_int[0] += self.p_int[0] '''] = ('''self.p_int[0] += self.p_int[0] ''',self.guard64,self.act64)

        self.__actionClass['''self.p_int[0] += self.p_int[0] '''] = '''<int> += <int> '''

        self.__orderings['''self.p_int[0] += self.p_int[0] '''] = 65

        self.__okExcepts['''self.p_int[0] += self.p_int[0] '''] = ''''''

        self.__actions.append(('''self.p_int[0] += self.p_int[1] ''',self.guard65,self.act65))

        self.__names['''self.p_int[0] += self.p_int[1] '''] = ('''self.p_int[0] += self.p_int[1] ''',self.guard65,self.act65)

        self.__actionClass['''self.p_int[0] += self.p_int[1] '''] = '''<int> += <int> '''

        self.__orderings['''self.p_int[0] += self.p_int[1] '''] = 66

        self.__okExcepts['''self.p_int[0] += self.p_int[1] '''] = ''''''

        self.__actions.append(('''self.p_int[0] += self.p_int[2] ''',self.guard66,self.act66))

        self.__names['''self.p_int[0] += self.p_int[2] '''] = ('''self.p_int[0] += self.p_int[2] ''',self.guard66,self.act66)

        self.__actionClass['''self.p_int[0] += self.p_int[2] '''] = '''<int> += <int> '''

        self.__orderings['''self.p_int[0] += self.p_int[2] '''] = 67

        self.__okExcepts['''self.p_int[0] += self.p_int[2] '''] = ''''''

        self.__actions.append(('''self.p_int[0] += self.p_int[3] ''',self.guard67,self.act67))

        self.__names['''self.p_int[0] += self.p_int[3] '''] = ('''self.p_int[0] += self.p_int[3] ''',self.guard67,self.act67)

        self.__actionClass['''self.p_int[0] += self.p_int[3] '''] = '''<int> += <int> '''

        self.__orderings['''self.p_int[0] += self.p_int[3] '''] = 68

        self.__okExcepts['''self.p_int[0] += self.p_int[3] '''] = ''''''

        self.__actions.append(('''self.p_int[1] += self.p_int[0] ''',self.guard68,self.act68))

        self.__names['''self.p_int[1] += self.p_int[0] '''] = ('''self.p_int[1] += self.p_int[0] ''',self.guard68,self.act68)

        self.__actionClass['''self.p_int[1] += self.p_int[0] '''] = '''<int> += <int> '''

        self.__orderings['''self.p_int[1] += self.p_int[0] '''] = 69

        self.__okExcepts['''self.p_int[1] += self.p_int[0] '''] = ''''''

        self.__actions.append(('''self.p_int[1] += self.p_int[1] ''',self.guard69,self.act69))

        self.__names['''self.p_int[1] += self.p_int[1] '''] = ('''self.p_int[1] += self.p_int[1] ''',self.guard69,self.act69)

        self.__actionClass['''self.p_int[1] += self.p_int[1] '''] = '''<int> += <int> '''

        self.__orderings['''self.p_int[1] += self.p_int[1] '''] = 70

        self.__okExcepts['''self.p_int[1] += self.p_int[1] '''] = ''''''

        self.__actions.append(('''self.p_int[1] += self.p_int[2] ''',self.guard70,self.act70))

        self.__names['''self.p_int[1] += self.p_int[2] '''] = ('''self.p_int[1] += self.p_int[2] ''',self.guard70,self.act70)

        self.__actionClass['''self.p_int[1] += self.p_int[2] '''] = '''<int> += <int> '''

        self.__orderings['''self.p_int[1] += self.p_int[2] '''] = 71

        self.__okExcepts['''self.p_int[1] += self.p_int[2] '''] = ''''''

        self.__actions.append(('''self.p_int[1] += self.p_int[3] ''',self.guard71,self.act71))

        self.__names['''self.p_int[1] += self.p_int[3] '''] = ('''self.p_int[1] += self.p_int[3] ''',self.guard71,self.act71)

        self.__actionClass['''self.p_int[1] += self.p_int[3] '''] = '''<int> += <int> '''

        self.__orderings['''self.p_int[1] += self.p_int[3] '''] = 72

        self.__okExcepts['''self.p_int[1] += self.p_int[3] '''] = ''''''

        self.__actions.append(('''self.p_int[2] += self.p_int[0] ''',self.guard72,self.act72))

        self.__names['''self.p_int[2] += self.p_int[0] '''] = ('''self.p_int[2] += self.p_int[0] ''',self.guard72,self.act72)

        self.__actionClass['''self.p_int[2] += self.p_int[0] '''] = '''<int> += <int> '''

        self.__orderings['''self.p_int[2] += self.p_int[0] '''] = 73

        self.__okExcepts['''self.p_int[2] += self.p_int[0] '''] = ''''''

        self.__actions.append(('''self.p_int[2] += self.p_int[1] ''',self.guard73,self.act73))

        self.__names['''self.p_int[2] += self.p_int[1] '''] = ('''self.p_int[2] += self.p_int[1] ''',self.guard73,self.act73)

        self.__actionClass['''self.p_int[2] += self.p_int[1] '''] = '''<int> += <int> '''

        self.__orderings['''self.p_int[2] += self.p_int[1] '''] = 74

        self.__okExcepts['''self.p_int[2] += self.p_int[1] '''] = ''''''

        self.__actions.append(('''self.p_int[2] += self.p_int[2] ''',self.guard74,self.act74))

        self.__names['''self.p_int[2] += self.p_int[2] '''] = ('''self.p_int[2] += self.p_int[2] ''',self.guard74,self.act74)

        self.__actionClass['''self.p_int[2] += self.p_int[2] '''] = '''<int> += <int> '''

        self.__orderings['''self.p_int[2] += self.p_int[2] '''] = 75

        self.__okExcepts['''self.p_int[2] += self.p_int[2] '''] = ''''''

        self.__actions.append(('''self.p_int[2] += self.p_int[3] ''',self.guard75,self.act75))

        self.__names['''self.p_int[2] += self.p_int[3] '''] = ('''self.p_int[2] += self.p_int[3] ''',self.guard75,self.act75)

        self.__actionClass['''self.p_int[2] += self.p_int[3] '''] = '''<int> += <int> '''

        self.__orderings['''self.p_int[2] += self.p_int[3] '''] = 76

        self.__okExcepts['''self.p_int[2] += self.p_int[3] '''] = ''''''

        self.__actions.append(('''self.p_int[3] += self.p_int[0] ''',self.guard76,self.act76))

        self.__names['''self.p_int[3] += self.p_int[0] '''] = ('''self.p_int[3] += self.p_int[0] ''',self.guard76,self.act76)

        self.__actionClass['''self.p_int[3] += self.p_int[0] '''] = '''<int> += <int> '''

        self.__orderings['''self.p_int[3] += self.p_int[0] '''] = 77

        self.__okExcepts['''self.p_int[3] += self.p_int[0] '''] = ''''''

        self.__actions.append(('''self.p_int[3] += self.p_int[1] ''',self.guard77,self.act77))

        self.__names['''self.p_int[3] += self.p_int[1] '''] = ('''self.p_int[3] += self.p_int[1] ''',self.guard77,self.act77)

        self.__actionClass['''self.p_int[3] += self.p_int[1] '''] = '''<int> += <int> '''

        self.__orderings['''self.p_int[3] += self.p_int[1] '''] = 78

        self.__okExcepts['''self.p_int[3] += self.p_int[1] '''] = ''''''

        self.__actions.append(('''self.p_int[3] += self.p_int[2] ''',self.guard78,self.act78))

        self.__names['''self.p_int[3] += self.p_int[2] '''] = ('''self.p_int[3] += self.p_int[2] ''',self.guard78,self.act78)

        self.__actionClass['''self.p_int[3] += self.p_int[2] '''] = '''<int> += <int> '''

        self.__orderings['''self.p_int[3] += self.p_int[2] '''] = 79

        self.__okExcepts['''self.p_int[3] += self.p_int[2] '''] = ''''''

        self.__actions.append(('''self.p_int[3] += self.p_int[3] ''',self.guard79,self.act79))

        self.__names['''self.p_int[3] += self.p_int[3] '''] = ('''self.p_int[3] += self.p_int[3] ''',self.guard79,self.act79)

        self.__actionClass['''self.p_int[3] += self.p_int[3] '''] = '''<int> += <int> '''

        self.__orderings['''self.p_int[3] += self.p_int[3] '''] = 80
    ...
    def state(self):
        ...
        return [ copy.deepcopy(self.p_int),copy.deepcopy(self.p_int_used),copy.copy(self.__test)]
    ...
    def check(self):
        try:
            ...
            # BEGIN CHECK CODE
            # GLOBAL self.p_int[0]
            if (self.p_int[0] != None) and (self.p_int[0] != None): # CHECK POOL INIT
                assert add.add(self.p_int[0],self.p_int[0]) == add.add(self.p_int[0],self.p_int[0])
            # GLOBAL self.p_int[1]
            if (self.p_int[0] != None) and (self.p_int[1] != None): # CHECK POOL INIT
                assert add.add(self.p_int[0],self.p_int[1]) == add.add(self.p_int[1],self.p_int[0])
            # GLOBAL self.p_int[2]
            if (self.p_int[0] != None) and (self.p_int[2] != None): # CHECK POOL INIT
                assert add.add(self.p_int[0],self.p_int[2]) == add.add(self.p_int[2],self.p_int[0])
            # GLOBAL self.p_int[3]
            if (self.p_int[0] != None) and (self.p_int[3] != None): # CHECK POOL INIT
                assert add.add(self.p_int[0],self.p_int[3]) == add.add(self.p_int[3],self.p_int[0])
            if (self.p_int[1] != None) and (self.p_int[0] != None): # CHECK POOL INIT
                assert add.add(self.p_int[1],self.p_int[0]) == add.add(self.p_int[0],self.p_int[1])
            if (self.p_int[1] != None) and (self.p_int[1] != None): # CHECK POOL INIT
                assert add.add(self.p_int[1],self.p_int[1]) == add.add(self.p_int[1],self.p_int[1])
            if (self.p_int[1] != None) and (self.p_int[2] != None): # CHECK POOL INIT
                assert add.add(self.p_int[1],self.p_int[2]) == add.add(self.p_int[2],self.p_int[1])
            if (self.p_int[1] != None) and (self.p_int[3] != None): # CHECK POOL INIT
                assert add.add(self.p_int[1],self.p_int[3]) == add.add(self.p_int[3],self.p_int[1])
            if (self.p_int[2] != None) and (self.p_int[0] != None): # CHECK POOL INIT
                assert add.add(self.p_int[2],self.p_int[0]) == add.add(self.p_int[0],self.p_int[2])
            if (self.p_int[2] != None) and (self.p_int[1] != None): # CHECK POOL INIT
                assert add.add(self.p_int[2],self.p_int[1]) == add.add(self.p_int[1],self.p_int[2])
            if (self.p_int[2] != None) and (self.p_int[2] != None): # CHECK POOL INIT
                assert add.add(self.p_int[2],self.p_int[2]) == add.add(self.p_int[2],self.p_int[2])
            if (self.p_int[2] != None) and (self.p_int[3] != None): # CHECK POOL INIT
                assert add.add(self.p_int[2],self.p_int[3]) == add.add(self.p_int[3],self.p_int[2])
            if (self.p_int[3] != None) and (self.p_int[0] != None): # CHECK POOL INIT
                assert add.add(self.p_int[3],self.p_int[0]) == add.add(self.p_int[0],self.p_int[3])
            if (self.p_int[3] != None) and (self.p_int[1] != None): # CHECK POOL INIT
                assert add.add(self.p_int[3],self.p_int[1]) == add.add(self.p_int[1],self.p_int[3])
            if (self.p_int[3] != None) and (self.p_int[2] != None): # CHECK POOL INIT
                assert add.add(self.p_int[3],self.p_int[2]) == add.add(self.p_int[2],self.p_int[3])
            if (self.p_int[3] != None) and (self.p_int[3] != None): # CHECK POOL INIT
                assert add.add(self.p_int[3],self.p_int[3]) == add.add(self.p_int[3],self.p_int[3])
            # END CHECK CODE
